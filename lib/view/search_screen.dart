...
import 'package:manga_reader_app/view/widgets/search_app_bar_widget.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    late final PagingController<int, MangaData> pagingController =
        Provider.of<SearchViewModel>(context, listen: false).pagingController;
            ...
            builderDelegate: PagedChildBuilderDelegate(
              noItemsFoundIndicatorBuilder: (_) => Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  Text(
                    'No result yet. Enter a keyword to begin',
