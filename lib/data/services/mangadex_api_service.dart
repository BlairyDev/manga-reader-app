...
class MangadexApiService {
  ...
  Future<Map<String, dynamic>> fetchSearchManga(
    ...
    final String upcomingAPI =
        "https://api.mangadex.org/manga?limit=6&offset=${offset}&title=${text}&includedTagsMode=AND&excludedTagsMode=OR&contentRating%5B%5D=safe&contentRating%5B%5D=suggestive&contentRating%5B%5D=erotica&order%5BlatestUploadedChapter%5D=desc&includes[]=artist&includes[]=author&includes[]=cover_art";
